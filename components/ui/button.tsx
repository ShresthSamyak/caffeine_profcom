...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
        default:
          "bg-coffee-700 text-cream-50 shadow hover:bg-coffee-800",
        primary:
          "bg-gradient-to-br from-coffee-600 to-coffee-800 text-white shadow-lg hover:shadow-xl hover:from-coffee-700 hover:to-coffee-900 font-semibold",
        outline:
          "border border-coffee-300 bg-transparent text-coffee-700 hover:bg-coffee-50",
        ghost:
          "text-coffee-700 hover:bg-coffee-50",
        cream:
          "bg-cream-100 text-coffee-800 hover:bg-cream-200 shadow-sm",
        destructive:
          "bg-red-500 text-white hover:bg-red-600 shadow",
        link:
          "text-coffee-600 underline-offset-4 hover:underline p-0 h-auto",
      },
      size: {
